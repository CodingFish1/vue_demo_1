...
const App = {
  ...
  methods: {
    showDetail(item){
      this.selectedItem={};
      this.selectedItem.category=item.category;
      this.selectedItem.content=item.content;
      this.selectedItem.description=item.description;
      this.selectedItem.id=item.id;
      this.selectedItem.is_enabled=item.is_enabled;
      this.selectedItem.origin_price=item.origin_price;
      this.selectedItem.price=item.price;
      this.selectedItem.title=item.title;
      this.selectedItem.unit=item.unit;
      this.selectedItem.num=item.num;
      this.selectedItem.imageUrl=item.imageUrl;
      this.selectedItem.imagesUrl=item.imagesUrl;
